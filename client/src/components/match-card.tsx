...
interface MatchCardProps {
  ...
  tossPredictionCounts: { [teamId: number]: number };
  matchPredictionCounts: { [teamId: number]: number };
}

const MatchCard = ({ match, userPrediction, tossPredictionCounts, matchPredictionCounts }: MatchCardProps) => {
  const { user } = useAuth();
